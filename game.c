...
void charactersMovement (ALLEGRO_EVENT event, character *player1, character *player2) {
    if (event.keyboard.keycode == ALLEGRO_KEY_W) {
        ...
        if ((event.type == ALLEGRO_EVENT_KEY_DOWN) && (player1->state != DOWN) && (player1->state != AIR) && (player1->state != ATTACK)) {
            player1->state = AIR;
    ...
    if (event.keyboard.keycode == ALLEGRO_KEY_A) {
        ...
        if ((player1->state != DOWN) && (player1->state != AIR) && (player1->state != ATTACK)) {
            player1->state = WALK;
    ...
    if (event.keyboard.keycode == ALLEGRO_KEY_S) {
        ...
        if ((player1->state != AIR) && (player1->state != ATTACK)) {
            player1->state = DOWN;
    ...
    if (event.keyboard.keycode == ALLEGRO_KEY_UP) {
        ...
        if ((event.type == ALLEGRO_EVENT_KEY_DOWN) && (player2->state != DOWN) && (player2->state != AIR) && (player2->state != ATTACK)) {
            player2->state = AIR;
    ...
    if (event.keyboard.keycode == ALLEGRO_KEY_LEFT) {
        ...
        if ((player2->state != DOWN) && (player2->state != AIR) && (player2->state != ATTACK)) {
            player2->state = WALK;
    ...
    if (event.keyboard.keycode == ALLEGRO_KEY_DOWN) {
        ...
        if ((player2->state != AIR) && (player2->state != ATTACK)) {
            player2->state = DOWN;
...
void update_position(character *player1, character *player2) {
    if ((player1->state != AIR) && !((player1->control->up) || (player1->control->down) ||
        (player1->control->left) || (player1->control->right)) && (player1->state != IDLE) && (player1->state != ATTACK)) {
        player1->state = IDLE;
    ...
    /* Adicionar para o player 2. */
    if ((player1->state != DOWN) && (player1->state != ATTACK)) {
    ...
    if ((player2->state != AIR) && !((player2->control->up) || (player2->control->down) ||
        (player2->control->left) || (player2->control->right)) && (player2->state != IDLE) && (player2->state != ATTACK)) {
        player2->state = IDLE;
    ...
    if ((player2->state != DOWN) && (player2->state != ATTACK)) {
